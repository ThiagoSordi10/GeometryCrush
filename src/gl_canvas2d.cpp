/*
Funções básicas do OpenGL implementadas e que são chamadas na main
*/
...
//Função própria para preenchimento de triangulo
void triangleFill(int x, int y, int elems){
    float vx[] = {x-25, x, x+25};
    float vy[] = {y-25, y+25, y-25};
    polygonFill(vx, vy, elems);
}
...
//texto especial para titulo inicial
void textInicio(int x, int y, const char *t)
{
    int tam = (int)strlen(t);
    int c;
